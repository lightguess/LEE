package com.lg.compiler;


import com.google.auto.service.AutoService;
import com.lg.annotation.ARouter;
import com.lg.annotation.model.RouterBean;
import com.lg.compiler.utils.Constants;
import com.lg.compiler.utils.EmptyUtils;
...
@AutoService(Processor.class)                               // AutoService用来注册,可以自动生成AutoService注解处理器,生成 META-INF/services/javax.annotation.processing.Processor 文件
@SupportedAnnotationTypes({Constants.AROUTER_ANNOTATION_TYPES})  //处理器的定义
...
public class ARouterProcessor  extends AbstractProcessor {
    ...
    private Elements elementUtils; //Elements 工具类

    private Types typeUtils;       //操作TypeMirror的工具方法

    private Messager messager;       //用于警告

    private Filer filer;             //文件生成器 类/资源
